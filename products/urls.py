...
urlpatterns = [
    ...
    path('api/ingredients/', IngredientsListAPIView.as_view(), name='ingredients-list'),
    #path('api/ingredients/<int:pk>/', IngredientsDetailAPIView.as_view(), name='ingredients-detail'),
